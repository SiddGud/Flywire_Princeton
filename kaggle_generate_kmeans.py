...
print(f"1. Loading Edge Lists from {DATA1}...")
...
b_f_pairs = []
b_m_pairs = []
matched_b, matched_f, matched_m = set(), set(), set()
...
out_file = '/kaggle/working/kmeans_triplets.csv'
triplets.to_csv(out_file, index=False)
print(f"Saved to {out_file}. Total time: {time.time()-t_start:.0f}s")
