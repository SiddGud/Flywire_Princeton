...
KMEANS_FILE = '/kaggle/working/kmeans_triplets.csv'
...
if __name__ == '__main__':
    print("\n" + "="*60)
    print(f"  K-MEANS ALIGNMENT SWEEP  |  Best to beat: {CURRENT_BEST}")
    print("="*60)
    ...
    print(f"\nLoading K-Means triplets from {KMEANS_FILE}...")
    triplets = pd.read_csv(KMEANS_FILE, dtype=str)
    ...
    alphas = [2, 5, 8, 10, 15]
    tasks  = [(a, s, be, fe, me, N) for a in alphas for s in range(45)]
    ...
    out = f'{OUT_DIR}/submission_KMEANS_{final_n}.csv'
